...
class SubscriptionServiceTest {
    ...
    @Mock SubscriptionCheckoutService checkoutService;
    @Mock SubscriptionPaymentApprovedHandler paymentApprovedHandler;
    @Mock SubscriptionPreapprovalWebhookHandler preapprovalWebhookHandler;
    ...
    @BeforeEach
    void setUp() {
        service = new SubscriptionService(subscriptionRepository, checkoutService,
                paymentApprovedHandler, preapprovalWebhookHandler, new SubscriptionMapper());
