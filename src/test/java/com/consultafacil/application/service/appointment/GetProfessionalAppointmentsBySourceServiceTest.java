...
class GetProfessionalAppointmentsBySourceServiceTest {
    ...
    void setUp() {
        ...
        service = new GetProfessionalAppointmentsBySourceService(professionalProfileRepository, appointmentRepository,
                new AppointmentMapper());
    }

    @Test
    void execute_existingProfessional_returnsFilteredPage() {
        ...
        var result = service.execute("prof-1", AppointmentSource.ONLINE, pageable);
    ...
    void execute_professionalNotFound_returnsEmptyPage() {
        ...
        var result = service.execute("bad", AppointmentSource.ONLINE, pageable);
