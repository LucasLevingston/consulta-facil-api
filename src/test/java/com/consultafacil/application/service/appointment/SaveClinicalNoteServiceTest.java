...
class SaveClinicalNoteServiceTest {
    ...
    @InjectMocks SaveClinicalNoteService service;
    ...
    @Test
    void execute_newNote_createsClinicalNote() {
        ...
        var result = service.execute("appt-1", "u-2", dto);
    ...
    @Test
    void execute_existingNote_updatesFields() {
        when(appointmentRepository.findById("appt-1")).thenReturn(Optional.of(appointment));
        ...
        service.execute("appt-1", "u-2", dto);
    ...
    void execute_appointmentNotFound_throwsNotFound() {
        ...
        assertThatThrownBy(() -> service.execute("bad", "u-2", new SaveClinicalNoteDTO()))
