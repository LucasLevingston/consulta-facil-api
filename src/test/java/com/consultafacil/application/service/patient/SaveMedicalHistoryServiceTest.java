...
class SaveMedicalHistoryServiceTest {
    ...
    @InjectMocks SaveMedicalHistoryService service;
    ...
    @Test
    void execute_newHistory_creates() {
        ...
        var result = service.execute("appt-1", "u-1", dto);
    ...
    void execute_appointmentNotFound_throwsNotFound() {
        ...
        assertThatThrownBy(() -> service.execute("bad", "u-1", new SaveMedicalHistoryDTO()))
