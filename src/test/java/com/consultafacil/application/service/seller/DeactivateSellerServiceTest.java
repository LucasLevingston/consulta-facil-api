...
class DeactivateSellerServiceTest {
    ...
    void setUp() {
        ...
        service = new DeactivateSellerService(sellerRepository, mapper);
    ...
    @Test
    void execute_setsStatusInactive() {
