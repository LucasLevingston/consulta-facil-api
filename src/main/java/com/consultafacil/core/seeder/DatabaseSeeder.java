...
import com.consultafacil.core.seeder.professional.enrichment.AddressSeeder;
import com.consultafacil.core.seeder.user.AdminUserSeeder;
import com.consultafacil.core.seeder.appointment.AnamnesisSeeder;
import com.consultafacil.core.seeder.appointment.AppointmentBulkSeeder;
import com.consultafacil.core.seeder.billing.BillingPaymentSeeder;
import com.consultafacil.core.seeder.patient.BulkPatientSeeder;
import com.consultafacil.core.seeder.appointment.BulkProfessionalAppointmentSeeder;
import com.consultafacil.core.seeder.professional.profile.BulkProfessionalSeeder;
import com.consultafacil.core.seeder.clinic.ClinicSeeder;
import com.consultafacil.core.seeder.clinic.ClinicWorkingHoursSeeder;
import com.consultafacil.core.seeder.appointment.ClinicalNoteAndExamRequestSeeder;
import com.consultafacil.core.seeder.coupon.CouponSeeder;
import com.consultafacil.core.seeder.coupon.CouponUseSeeder;
import com.consultafacil.core.seeder.patient.EmergencyContactSeeder;
import com.consultafacil.core.seeder.examlab.ExamLabSeeder;
import com.consultafacil.core.seeder.patient.MedicalRecordSeeder;
import com.consultafacil.core.seeder.notification.NotificationSeeder;
import com.consultafacil.core.seeder.appointment.OnlineAppointmentSeeder;
import com.consultafacil.core.seeder.plan.PlanSeeder;
import com.consultafacil.core.seeder.clinic.ReceptionistSeeder;
import com.consultafacil.core.seeder.professional.schedule.ScheduleSeeder;
import com.consultafacil.core.seeder.professional.schedule.ScheduleTemplate;
import com.consultafacil.core.seeder.seller.SellerSaleSeeder;
import com.consultafacil.core.seeder.seller.SellerSeeder;
import com.consultafacil.core.seeder.procedurerequest.ServiceAndProcedureRequestSeeder;
import com.consultafacil.core.seeder.subscription.SubscriptionPaymentSeeder;
import com.consultafacil.core.seeder.subscription.SubscriptionSeeder;
import com.consultafacil.core.seeder.appointment.TestAppointmentSeeder;
import com.consultafacil.core.seeder.user.TestUserSeeder;
