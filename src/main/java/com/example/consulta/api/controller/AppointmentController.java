...
public class AppointmentController {
    ...
    public ResponseEntity<MedicalHistoryResponseDTO> getAnamnesis(@PathVariable String appointmentId) {
        return medicalHistoryService.getByAppointmentId(appointmentId)
    ...
    @Operation(summary = "Get clinicalNote for an appointment")
    public ResponseEntity<ClinicalNoteResponseDTO> getClinicalNote(@PathVariable String appointmentId) {
        return clinicalNoteService.getByAppointmentId(appointmentId)
                .map(ResponseEntity::ok)
                .orElse(ResponseEntity.noContent().build());
    }
